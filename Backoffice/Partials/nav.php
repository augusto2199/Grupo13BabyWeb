        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form>
                        <div class="mb-3">
                            <p class="text-center mt-3">Recibirás un enlace para restablecer tu contraseña. Por favor
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <p>
                        Al acceder y utilizar nuestro sitio, aceptas estar sujeto a estos Términos y Condiciones, así
                        como a
                    ...
                    <p>
                        Todo el contenido disponible en nuestro sitio, incluyendo textos, gráficos, logotipos, imágenes
                        y
                        software, es propiedad de la Liga Argentina de Baby Fútbol o sus proveedores y está protegido
                        por
                    ...
                    <h6>7. Terminación</h6>
                    <p>
                        Podemos cancelar o suspender tu cuenta en cualquier momento, sin previo aviso, si violas alguno
                        de
                    ...
                    <p>
                        No somos responsables de ningún daño directo, indirecto, incidental o consecuente que resulte
                        del
                    ...
                    <p>
                        ...
                        Cualquier
                        disputa que surja del uso del sitio será resuelta ante los tribunales competentes de la Ciudad
                        de
                        Buenos Aires.
                    </p>
                ...
                <div class="modal-body p-0">
                    <div class="row g-0 h-100">
                        ...
                        <div class="col-md-6 d-flex flex-column position-relative">
                            ...
                            <img src="./img/pelotas.jpg" alt="Imagen de contacto" class="img-fluid position-absolute"
                                style="top: 0; left: 0; width: calc(100% - 20px); height: calc(100% - 20px); object-fit: cover; 
                            ...
                            <div class="position-absolute top-0 start-0 p-4" style="z-index: 1; color: black;">
                                <p class="lead mb-2">Nuestro horario de atención es de lunes a viernes de 10 a 18 Hs.
                                </p>
                                <ul class="mb-0">
