    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <button type="button" class="btn btn-outline-primary w-100" data-bs-toggle="modal" data-bs-target="#registroModal">
...
<!-- Agregar el script de Bootstrap para que el modal funcione -->
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form>
                            <div class="mb-3">
                                <p class="text-center mt-3">Recibirás un enlace para restablecer tu contraseña. Por
                                    favor
                                    completa e proceso ya que el enlace expiara despues de un tiempo determinado</p>
                                <label for="resetEmail" class="form-label">Correo Electrónico</label>
                                <input type="email" class="form-control" id="resetEmail"
                                    placeholder="Introduce tu correo">
                            </div>
                            <button type="submit" class="btn btn-primary w-100">Enviar Enlace de
        ...
        <div class="modal fade" id="terminosModal" tabindex="-1" aria-labelledby="terminosModalLabel"
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p>
                            Bienvenido a la Liga Argentina de Baby Fútbol. Al registrarte en nuestro sitio web, aceptas
                            cumplir
                        ...
                        <p>
                            Al acceder y utilizar nuestro sitio, aceptas estar sujeto a estos Términos y Condiciones,
                            así
                            como a
                            nuestra Política de Privacidad. Si no estás de acuerdo con alguna parte de estos términos,
                            no
                        ...
                        <p>
                            ...
                            Argentina de Baby Fútbol. No debes utilizar este sitio para ningún propósito ilegal o no
                            autorizado.
                        ...
                        <p>
                            Para registrarte, debes proporcionar información veraz, completa y actualizada. Al crear una
                            cuenta,
                            te comprometes a no compartir tu información de acceso con terceros. Eres responsable de
                            mantener la
                        ...
                        <p>
                            ...
                            recopilamos, utilizamos y protegemos tu información personal. Te recomendamos leerla para
                            comprender
                        ...
                        <p>
                            Todo el contenido disponible en nuestro sitio, incluyendo textos, gráficos, logotipos,
                            imágenes
                            y
                            software, es propiedad de la Liga Argentina de Baby Fútbol o sus proveedores y está
                            protegido
                            por
                        ...
                        <p>
                            ...
                            notificaremos sobre los cambios publicando los términos actualizados en nuestro sitio web.
                            Es tu
                            responsabilidad revisar estos términos periódicamente para estar al tanto de las
                            modificaciones.
                        </p>

                        <h6>7. Terminación</h6>
                        <p>
                            Podemos cancelar o suspender tu cuenta en cualquier momento, sin previo aviso, si violas
                            alguno
                            de
                            estos términos. También puedes cerrar tu cuenta en cualquier momento poniéndote en contacto
                            con
                            nosotros.
                        </p>
                        ...
                        <p>
                            No somos responsables de ningún daño directo, indirecto, incidental o consecuente que
                            resulte
                            del
                        ...
                        <p>
                            Estos Términos y Condiciones se rigen por las leyes vigentes en la República Argentina.
                            Cualquier
                            disputa que surja del uso del sitio será resuelta ante los tribunales competentes de la
                            Ciudad
                            de
                            Buenos Aires.
                        </p>
        ...
        <div class="modal fade" id="ContactoModal" tabindex="-1" aria-labelledby="ContactoModalLabel"
            ...
            <div class="modal-dialog modal-lg">
                ...
                <div class="modal-content" style="height: 90vh;">
                    <!-- Altura del modal un poco menor que el viewport -->
                    <div class="modal-header">
                        <img src="./img/argentina.png" alt="Logo"
                            style="height: 65px; width: auto; opacity: 8; margin-right: 10px;">
                    ...
                    <div class="modal-body p-0">
                        <div class="row g-0 h-100">
                            ...
                            <div class="col-md-6 d-flex flex-column position-relative">
                                ...
                                <img src="./img/pelotas.jpg" alt="Imagen de contacto"
                                    class="img-fluid position-absolute" style="top: 0; left: 0; width: calc(100% - 20px); height: calc(100% - 20px); object-fit: cover; 
                                ...
                                <div class="position-absolute top-0 start-0 p-4" style="z-index: 1; color: black;">
                                    <p class="lead mb-2">Nuestro horario de atención es de lunes a viernes de 10 a 18
                                        Hs.
                                    </p>
                                    <ul class="mb-0">
