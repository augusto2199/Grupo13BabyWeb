...
$jugador = $jugadorBusiness->find($_GET['id']);
...
<head>
    ...
    <title>Equipo: <?php echo $jugador->getNombre()?></title>
...
<body>
    ...
    <div>
        <form action="/../../GRUPO13BABYWEB/Backoffice/Controllers/jugadorEdit.php" class="container" method="POST" enctype="multipart/form-data">
            <div class="mb-3">
